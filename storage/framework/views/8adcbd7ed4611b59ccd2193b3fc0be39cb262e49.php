                                <div class="col-lg-12" style="padding:0px">
                                    <form class="sendchat">
                                        ...
                                        <input type="hidden" name="social_id" value="<?php echo e(Auth::user()->social_id); ?>">
                                        <input type="hidden" name="email" value="<?php echo e(Auth::user()->email); ?>">
                                        <input type="hidden" name="social_type" value="<?php echo e(Auth::user()->social_type); ?>">
                                        <input type="hidden" name="points" value="<?php echo e(Auth::user()->points); ?>">
                                        ...
                                        <input type="hidden" name="color" value="<?php echo e(Auth::user()->color); ?>">
                                        <input type="hidden" name="neon" value="<?php echo e(Auth::user()->neon); ?>">
                                            ...
                                            <span class="input-group-btn">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li ><a type="button" onclick="inew.addAnnc('<?php echo e(Auth::user()->name); ?>')" style="margin: 0px;cursor: pointer;"><i class="fa fa-bullhorn" aria-hidden="true"></i> Announce</a></li>
                                                        <?php endif; ?>
                                                    </ul>
                                                </div>
                                            </span>
                                    ...
                                    <div class="smilys" style="width:100%;height:auto;position:absolute;top:30px;left:0px;right:0px;background:#eee;padding:10px;z-index:99999;display:none;color:#222">
                                      ...
                                      <br>
                                      <?php 
                                      	$permittedall = array(111,1,2,3,4,5,6,7,8,9,12);
                                ...
                                <div class="loader" style="width: 100%;height: 100%;background: #fff;position: absolute;top: 0;left: 0;right: 0;bottom: 0;z-index: 20;text-align: center"><center><img src="<?php echo e(URL::to('/assetses/img/loading.gif')); ?>"></center></div>