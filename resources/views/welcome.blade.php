      ...
      <div class="row no-gutters">
        <div class="col-md-4 col-sm-4">
          ...
          <div class="panel panel-body onboard">
            <img src="{{ URL::to('assetses/img/logo.png') }}" class="ob-bg" alt="">
            <div class="media ob">
          ...
          <div class="panel panel-body profile">
            <div class="media">
              <div class="media-left">
                <img class="media-object user-img" src="{{ Auth::user()->avatar }}" alt="...">
              </div>
              <div class="media-body">
                <p class="media-heading user-name" onclick="location.href='/profile'">{{ Auth::user()->name }}</p>
		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner" role="listbox">
		    ...
		    <div class="item">
		  	...
		  	<!-- Slides -->
		    <div class="item">
		      <img src="/fansigns/fan3.jpg" style="height:320px;width:100%">
		    </div>
        ...
        <div class="col-md-8 col-sm-8">
          <div class="panel panel-body banner">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active">
                  <img src="http://i.imgur.com/GUL8wArl.jpg" alt="...">
                  <div class="carousel-caption">
                  </div>
                </div>
                <div class="item">
                  <img src="{{ URL::to('assetses/img/image_0.jpg') }}?template=generic" alt="...">
                  <div class="carousel-caption">
              ...
              <div class="panel">
                ...
                <div class="panel-body">
									...
									<ins class="adsbygoogle"
											 ...
											 data-ad-client="ca-pub-1934978959238605"
											 data-ad-slot="4651450375"></ins>
									<script>
