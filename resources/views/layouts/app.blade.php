...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::to('assetses/css/main.min.css') }}"/>
...
?>
    ...
    <header id="mainhead">
      <div class="container">
        <img src="{{ URL::to('assetses/img/logo.png') }}" class="img-responsive logo"/>
      </div>
    </header>
  ...
  <script type="text/javascript" src="{{ URL::to('/assetses/js/underscore-min.js') }}"></script>
